...
const productList: Product[] = [
  ...
  {
    id: "lampiao-recarregavel-ventilador-led",
    name: "Lampião Recarregável com Ventilador LED",
    category: "Casa",
    image: { placeholder: "/produtos/lampiao-ventilador-led.png", backgroundClass: "bg-[#d7f1e8]" },
    shortDescription: "Testei a iluminação, o ventilador e as diferentes formas de alimentação desse lampião multifuncional.",
    price: "Preço pendente",
    productLink: "[Link do produto pendente]",
    videos: [{ title: "Demonstração", videoLink: "https://vt.tiktok.com/ZSbNXY4hp/" }],
    status: "Testado",
    order: 12,
  },
  {
    id: "dobro-carbs-gel-starter-pack",
    name: "Dobro Carbs Gel — Starter Pack",
    category: "Suplementos",
    image: { placeholder: "/produtos/carbs-gel-dobro.png", backgroundClass: "bg-[#dcd4ff]" },
    shortDescription: "Testei o Starter Pack de Carbs Gel da Dobro, com 5 sachês e diferentes sabores para experimentar.",
    price: "Preço pendente",
    productLink: "[Link do produto pendente]",
    videos: [{ title: "Demonstração", videoLink: "https://vt.tiktok.com/ZSbNXF84B/" }],
    status: "Testado",
    order: 13,
  },
  {
    id: "torneira-gourmet-filtro-bica-flexivel",
    name: "Torneira Gourmet com Filtro e Bica Flexível",
    category: "Casa",
    image: { placeholder: "/produtos/torneira-gourmet-filtro.png", backgroundClass: "bg-[#ffd8be]" },
    shortDescription: "Testei os dois modos de jato, a bica flexível e o sistema de filtragem dessa torneira gourmet.",
    price: "Preço pendente",
    productLink: "[Link do produto pendente]",
    videos: [{ title: "Demonstração", videoLink: "https://vt.tiktok.com/ZSbNsorRe/" }],
    status: "Testado",
    order: 14,
  },
];
